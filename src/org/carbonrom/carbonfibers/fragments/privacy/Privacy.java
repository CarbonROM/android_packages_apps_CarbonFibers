...
public class Privacy extends SettingsPreferenceFragment implements
        Preference.OnPreferenceChangeListener, AlertDialog.OnClickListener {
    ...
    private alertReboot() {
        new AlertDialog.Builder(getActivity())
                ...
                .setPositiveButton(android.R.string.factorytest_reboot, this)
    ...
    public void onClick(DialogInterface dialog, int which) {
        switch (which) {
            case BUTTON_NEGATIVE:
                SecureSettingSwitchPreference pref = getPreferenceScreen()
                        .findPreference("untrusted_overlay_toggle");
                pref.persisteBoolean(false);
                dialog.dismiss();
                break;
