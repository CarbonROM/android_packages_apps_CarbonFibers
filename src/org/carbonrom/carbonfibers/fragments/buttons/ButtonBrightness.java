...
public class ButtonBrightness extends CustomSettingsPreferenceFragment implements Preference.OnPreferenceChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addCustomPreference(findPreference(KEY_BUTTON_BACKLIGHT_ENABLE), SECURE_TWO_STATE, STATE_ON);
        addCustomPreference(findPreference(KEY_BUTTON_USE_SCREEN_BRIGHTNESS), SYSTEM_TWO_STATE, STATE_ON);
