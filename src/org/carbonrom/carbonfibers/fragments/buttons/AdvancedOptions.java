...
/**
        /* hide navbar options when hardware home key exists 
        if (hasHomeKey) {
             mNavigationPreferencesCat.removePreference(mNavHomeLongPressAction);
             mNavigationPreferencesCat.removePreference(mNavHomeDoubleTapAction);
        }  */
