...
public class AdvancedOptions extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        /* Navbar Home Long Press */
        int defaultLongPressOnNavHomeBehavior = res.getInteger(
               com.android.internal.R.integer.config_longPressOnHomeKeyBehavior);
        int longPressOnNavHomeBehavior = Settings.System.getIntForUser(resolver,
                   Settings.System.KEY_HOME_LONG_PRESS_ACTION,
                   defaultLongPressOnNavHomeBehavior,
                   UserHandle.USER_CURRENT);
        mNavHomeLongPressAction = initActionList(KEY_HOME_LONG_PRESS, longPressOnNavHomeBehavior);
        ...
        /* Navbar Home Key Double Tap */
        int defaultDoubleTapOnNavHomeBehavior = res.getInteger(
                 com.android.internal.R.integer.config_doubleTapOnHomeKeyBehavior);
        int doubleTapOnNavHomeBehavior = Settings.System.getIntForUser(resolver,
                    Settings.System.KEY_HOME_DOUBLE_TAP_ACTION,
                    defaultDoubleTapOnNavHomeBehavior,
                    UserHandle.USER_CURRENT);
        mNavHomeDoubleTapAction = initActionList(KEY_HOME_DOUBLE_TAP, doubleTapOnNavHomeBehavior);
    ...
    private String getSystemPreferenceString(Preference preference) {
        if (preference == null) {
            ...
            return Settings.System.NAVIGATION_BAR_ENABLED;
                   ...
                   preference == mNavHomeLongPressAction) {
            return Settings.System.KEY_HOME_LONG_PRESS_ACTION;
        } else if (preference == mHomeDoubleTapAction ||
                    preference == mNavHomeDoubleTapAction){
    ...
    private void reload() {
        ...
        final PreferenceCategory navkeysCategory =
                (PreferenceCategory) prefScreen.findPreference(KEY_CATEGORY_NAV);


        if (navigationBarEnabled && navkeysCategory != null) {
           navkeysCategory.setEnabled(navigationBarEnabled);
        } else if (!navigationBarEnabled && navkeysCategory != null) {
           prefScreen.removePreference(navkeysCategory);
        }
