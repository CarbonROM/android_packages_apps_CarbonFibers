...
public class AdvancedOptions extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mNavHomeLongPressAction = initActionList(KEY_NAVIGATION_HOME_LONG_PRESS, longPressOnNavHomeBehavior);
        ...
        int doubleTapOnNavHomeBehavior = Settings.System.getIntForUser(resolver,
                    ...
                    UserHandle.USER_CURRENT);
        mNavHomeDoubleTapAction = initActionList(KEY_NAVIGATION_HOME_DOUBLE_TAP, doubleTapOnNavHomeBehavior);
    ...
    private void reload() {
        ...
        if (!hasHome && navkeysCategory != null) {
           navkeysCategory.setEnabled(navigationBarEnabled);
        } else if (hasHome && navkeysCategory != null) {
