...
public class CarbonGesturesSettings extends SettingsPreferenceFragment implements
    ...
    private ListPreference mCarbonGestureFingers;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mCarbonGestureFingers = (ListPreference) findPreference("carbon_gestures_fingers");
        ...
        mCarbonGestureFingers.setValue(String.valueOf(carbonGestureFingers));
        mCarbonGestureFingers.setSummary(mCarbonGestureFingers.getEntry());
    ...
    public boolean onPreferenceChange(Preference preference, Object objValue) {
        ...
        if (preference.equals(mCarbonGestureFingers)) {
            int carbonGestureFingers = Integer.parseInt(((String) objValue).toString());
            Settings.System.putIntForUser(getContentResolver(),
                    Settings.System.CARBON_CUSTOM_GESTURE_FINGERS, carbonGestureFingers, UserHandle.USER_CURRENT);
            int index = mCarbonGestureFingers.findIndexOfValue((String) objValue);
            mCarbonGestureFingers.setSummary(
                    mCarbonGestureFingers.getEntries()[index]);
            return true;
        }
