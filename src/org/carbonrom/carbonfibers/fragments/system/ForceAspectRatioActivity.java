...
import org.carbonrom.carbonfibers.fragments.privacy.hideappfromrecents.*;
...
public class ForceAspectRatioActivity extends Activity {
    ...
    public static final String KEY_PREFERENCE_APPS = "aspect_ratio_apps_pref";

    @Override
    @SuppressLint("WorldReadableFiles")
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setTitle(getResources().getText(R.string.force_aspect_ratio_apps_title));
    ...
    private void saveExcludeFromRecentsString() {
        ...
        Settings.System.putString(getContentResolver(),
                Settings.System.ASPECT_RATIO_APPS_LIST, sb.toString());
    }
