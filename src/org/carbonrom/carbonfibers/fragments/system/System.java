...
public class System extends CustomSettingsPreferenceFragment implements Preference.OnPreferenceChangeListener, Indexable {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addCustomPreference(findPreference(DASHBOARD_SUGESSTIONS), SYSTEM_TWO_STATE, STATE_OFF);
        addCustomPreference(findPreference(DASHBOARD_CONDITIONS), SYSTEM_TWO_STATE, STATE_OFF);
