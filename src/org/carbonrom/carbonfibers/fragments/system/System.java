...
public class System extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.e(TAG, "Getting AR Value: " + mAspectRatioEnabled ? 0 : 1);
    ...
    public boolean onPreferenceChange(Preference preference, Object objValue) {
        ...
        if (preference.equals(mImmersiveRecents)) {
            ...
            mAspectRatioEnabled = (boolean)objValue;
            Log.e(TAG, "Setting AR Value: " + mAspectRatioEnabled ? 0 : 1);
            Settings.System.putIntForUser(resolver,
                    Settings.System.ASPECT_RATIO_APPS_ENABLED, mAspectRatioEnabled ? 0 : 1, UserHandle.USER_CURRENT);
            mForceAspectRatioApps.setEnabled(mAspectRatioEnabled);
            return true;
        }
        return false;
